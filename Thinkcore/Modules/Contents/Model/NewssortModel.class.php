 ...
 * 新闻分类模型
 */
class NewssortModel extends CommonModel {
    ...
    public function clearCateCache(){
        S('Newssort_list',NULL);
    }

    public function getSortPath($id){
        $SortList = $this->getCateList();
        return $SortList[$id]['SortPath'];
    }
