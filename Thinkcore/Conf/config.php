...
/**
 * 站点配置
 * 注意：不建议改本文！欲配置，可加諸 addition.php中也
...
return array(
    ...
    'APP_GROUP_LIST' => 'Admin,User,Api,Attachment,Content', // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
...
/*    "USER_AUTH_ON" => true, //是否开启权限认证
    ...
    */
    ...
    'TMPL_PARSE_STRING' => array(
        ...
        '__JS_PATH__' => __ROOT__ . '/statics/js',
        '__IMAGES_PATH__'    => __ROOT__ . '/statics/images',
        '__CSS_PATH__'    => __ROOT__ . '/statics/css',
        '__TPL_JS__'     => __ROOT__ . '/statics/js/Tpl',
        '__TPL_CSS__'     => __ROOT__ . '/statics/css/Tpl',
        '__TPL_IMG__'     => __ROOT__ . '/statics/images/Tpl',

    ),


    'LOAD_EXT_CONFIG' => 'version,dataconfig,addition,rbac',
);
