...
class Page {
    ...
    public function GetCurrentPage() {
        $page = isset($_GET[$this->PageParam]) && intval($_GET[$this->PageParam]) > 0  ? intval($_GET[$this->PageParam]) : 1 ;
        $this->Current_page = ($page <= intval($this->Total_Pages) ? $page : intval($this->Total_Pages));
    }
